 ...
 */
@ActivityScoped
@Component(dependencies = MovieComponent.class, modules = {ListMovieActivityModule.class, ListMovieViewPagerAdapterModule.class, ListMovieRecyclerViewAdapterModule.class})
