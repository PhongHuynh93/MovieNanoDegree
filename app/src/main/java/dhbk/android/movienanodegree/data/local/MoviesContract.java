...
public final class MoviesContract {
    ...
    public static final String CONTENT_AUTHORITY = "me.maxdev.popularmoviesappp";
    ...
    /**
     * database show new movies, main db
     *
     * @see <a href="http://docs.themoviedb.apiary.io/#reference/discover/get"></a>
     */
     ...
     * depend on {@link MoviesContract.MovieEntry}
     */
    public static final class MostPopularMovies implements BaseColumns {
        public static final Uri CONTENT_URI = MovieEntry.CONTENT_URI.buildUpon().appendPath(PATH_MOST_POPULAR).build();
        public static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_MOVIES + "/" + PATH_MOST_POPULAR;
    ...
    public static final class HighestRatedMovies implements BaseColumns {
        public static final Uri CONTENT_URI = MovieEntry.CONTENT_URI.buildUpon().appendPath(PATH_HIGHEST_RATED).build();
        public static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_MOVIES + "/" + PATH_HIGHEST_RATED;
    ...
    /**
     * Get the list of most rated movies.
     * depend on {@link MoviesContract.MovieEntry}
     */
    public static final class MostRatedMovies implements BaseColumns {
        public static final Uri CONTENT_URI = MovieEntry.CONTENT_URI.buildUpon().appendPath(PATH_MOST_RATED).build();
        public static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_MOVIES + "/" + PATH_MOST_RATED;
    ...
    /**
     * get a list of my favorite movie
     * depend on {@link MoviesContract.MovieEntry}
     */
    public static final class Favorites implements BaseColumns {
        public static final Uri CONTENT_URI = MovieEntry.CONTENT_URI.buildUpon().appendPath(PATH_FAVORITES).build();

        public static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_MOVIES + "/" + PATH_FAVORITES;
